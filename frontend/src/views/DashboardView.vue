        ...
        <div class="map-full__panel">
          ...
          <ul class="map-full__items">
            <li
              ...
              :class="{ 'map-full__item--offline': c.status === 'OFFLINE' }"
            ...
            >
              ...
              <span v-if="c.status === 'OFFLINE'" class="map-full__down-dot" title="Offline"></span>
            </li>
...
.map-full__item--offline {
  border-left: 3px solid var(--red);
  background: rgba(239, 68, 68, 0.06);
}

.map-full__item--offline:hover {
