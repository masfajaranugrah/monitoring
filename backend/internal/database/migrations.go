...
-- Default interval ping 5 menit agar aman & ramah untuk perangkat pelanggan
-- (rate rata-rata ~10 ping/detik untuk 3.000 IP). Timeout 1 detik.
ALTER TABLE customers ALTER COLUMN ping_interval SET DEFAULT 300;
ALTER TABLE customers ALTER COLUMN timeout_ms SET DEFAULT 1000;
